module.exports = {
  ...
  transformIgnorePatterns: [
    'node_modules/(?!(@faker-js/faker|@mojaloop/ml-testing-toolkit-shared-lib|json-schema-ref-parser|@apidevtools/json-schema-ref-parser|json-schema-faker|commander|serialize-error|non-error)/)'
  ]
}
